...
type Condition struct {
	...
	// TODO add comments
	Matches *v1beta1.StringMatch `protobuf:"bytes,4,opt,name=matches,proto3" json:"matches,omitempty"`
}
...
func (x *Condition) GetMatches() *v1beta1.StringMatch {
	if x != nil {
		return x.Matches
	}
	return nil
...
var file_security_v1beta1_authorization_policy_proto_rawDesc = []byte{
	...
	0x08, 0x6e, 0x6f, 0x74, 0x50, 0x61, 0x74, 0x68, 0x73, 0x22, 0x95, 0x01, 0x0a, 0x09, 0x43, 0x6f,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x12, 0x39, 0x0a, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e,
	0x74, 0x79, 0x70, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x53, 0x74, 0x72,
	0x69, 0x6e, 0x67, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65,
...
var file_security_v1beta1_authorization_policy_proto_depIdxs = []int32{
	...
	11, // 9: istio.security.v1beta1.Condition.matches:type_name -> istio.type.v1beta1.StringMatch
