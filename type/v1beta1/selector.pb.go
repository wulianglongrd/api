...
var file_type_v1beta1_selector_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x2a, 0x4c, 0x0a, 0x0c, 0x57, 0x6f, 0x72, 0x6b, 0x6c,
...
var file_type_v1beta1_selector_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_type_v1beta1_selector_proto_goTypes = []any{
	...
	(*StringMatch)(nil),           // 4: istio.type.v1beta1.StringMatch
	nil,                           // 5: istio.type.v1beta1.WorkloadSelector.MatchLabelsEntry
}
var file_type_v1beta1_selector_proto_depIdxs = []int32{
	5, // 0: istio.type.v1beta1.WorkloadSelector.match_labels:type_name -> istio.type.v1beta1.WorkloadSelector.MatchLabelsEntry
...
func file_type_v1beta1_selector_proto_init() {
	...
	file_type_v1beta1_selector_proto_msgTypes[3].OneofWrappers = []any{
